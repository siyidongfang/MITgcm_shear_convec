...
for ns = 19
    ...
    load(['output/topo4_Nsq1e-6/growth_shear' num2str(shear*1e3,3) '_analysis.mat'])
    plot_timeseires
    print('-djpeg','-r150',['output/topo4_Nsq1e-6/growth_shear' num2str(shear*1e3,3) '_analysis.jpeg']);
