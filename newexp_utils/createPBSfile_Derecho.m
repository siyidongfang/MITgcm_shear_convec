...
%%%
function createPBSfile_Derecho (dirname,expname,nodes,walltime,cluster_path)
  ...
  '#PBS -l select=',num2str(ceil(nodes/128)),':ncpus=128:mpiprocs=128:ompthreads=1 \n' ...
  '#PBS -o output.txt \n' ...
  '#PBS -e errors.txt \n' ...
  '\n' ...
  'source /glade/u/home/ysi/.bashrc \n' ... %'source /etc/profile.d/modules.csh \n' ...
  '\n' ...
  ...%'cd ',cluster_path,'\n' ...
