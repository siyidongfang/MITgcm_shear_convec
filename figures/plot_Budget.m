...
% print('-dpng','-r300',['fig_supp_new/budget_topo4_R1_1.png']);
...
grid on;grid minor;
set(gca,'Fontsize',fontsize);
l5 = legend('Slope-normal velocity $w^\prime$',...
    'Along-canyon velocity perturbation $u^\prime$',...
    'Buoyancy perturbation $b^\prime$',...
    'Horizontal vorticity perturbation $\zeta$',...
    'interpreter','latex','Fontsize',fontsize-1,...
    'Position',[0.0624 0.7042 0.4639 0.1341]);
