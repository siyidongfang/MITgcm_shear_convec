...
function [nTimeSteps,h,tNorth,sNorth,rho_north,N]...
  ...
  % parm01.addParm('bottomDragQuadratic',0.8e-3,PARM_REAL);
...
%       ylabel('z (km)','Rotation',0);
  ...
  msk=zeros(Nx,Ny,Nr);
  %%% Horizontal Mask
  for j = 1:spongeThickness
      msk(:,j,:) =(spongeThickness-j+1)./spongeThickness; 
  end
  for j = Ny-spongeThickness+1:Ny
      msk(:,j,:) =(j-(Ny-spongeThickness))./spongeThickness; 
  end
...
%     layers_name = char('RHO'); 
  ...
  if(run_type~='prod')
        ...
        diag_fields_avg = {...   
            ...
            ... %'LaHc2TH','LaHc1RHO','LaPc2TH','LaPc1RHO','LaUH2TH','LaUH1RHO','LaHw1RHO','LaHw2TH','LaTr1RHO',...
            'LaTs2TH','LaTh2TH','LaTz2TH','LTha2TH','LTza2TH','LTto2TH',...
            ... % 'LaTs1TH' 'LaTh1TH' 'LaTz1TH' 'LTha1TH' 'LTza1TH' 'LTto1TH',...
            ...
            'TOTUTEND','TOTVTEND',...
...
if(run_type=='prod')
    diag_fields_inst = {...
        ...% 'UVEL','VVEL', 'WVEL','THETA','PHIHYD','PHI_NH','DRHODR','ETAN',...
           'UVEL','VVEL', 'WVEL','THETA','SALT','PHIHYD','PHI_NH','DRHODR','ETAN',...
           'RHOAnoma','LaVH1RHO','LaHs1RHO','LaVH2TH','LaHs2TH','LaUH1RHO','LaHw1RHO','LaUH2TH','LaHw2TH',...
