...
zq6_int = real((sum(zq6(:,zidx),2)))';
zq7_int = real((sum(zq7(:,zidx),2)))';
...
plot(ttd(1:Nt-1)/t1hour,(zq6_int./bq_all),'LineWidth',lw);
plot(ttd(1:Nt-1)/t1hour,(zq7_int./bq_all),'LineWidth',lw);
...
zq6_int = real(cumsum(sum(zq6(:,zidx),2)))';
zq7_int = real(cumsum(sum(zq7(:,zidx),2)))';
% zq_all = zq1_int+zq2_int+zq3_int+zq4_int+zq5_int+zq6_int+zq7_int;
zq_all = 1;
...
% semilogy(ttd(1:Nt-1)/t1hour,abs(zq6_int./bq_all),'LineWidth',lw);
% semilogy(ttd(1:Nt-1)/t1hour,abs(zq7_int./bq_all),'LineWidth',lw);
legend('zq1','zq2','zq3','zq4','zq5','zq6','zq7')
set(gca,'Fontsize',fontsize);
xlabel('Time (hours)')
grid on;grid minor;
...
semilogy(ttd(1:Nt-1)/t1hour,movmean(abs(zq6_int./bq_all),wins),'LineWidth',lw);
semilogy(ttd(1:Nt-1)/t1hour,movmean(abs(zq7_int./bq_all),wins),'LineWidth',lw);
legend('zq1','zq2','zq3','zq4','zq5','zq6','zq7')
set(gca,'Fontsize',fontsize);
xlabel('Time (hours)')
grid on;grid minor;
