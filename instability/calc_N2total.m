...
pidx = round(Nt/30*4): round(Nt/30*10);
...
figure();pcolor(plot_time,zz_dbdz,dB0_dz(pidx,:)');shading flat;clim([-3 3]/1e6);colormap(redblue);colorbar
figure();pcolor(plot_time,zz_dbdz,dB_dz(pidx,:)');shading flat;clim([-3 3]/1e6);colormap(redblue);colorbar
figure();pcolor(plot_time,zz_dbdz,dbdz(pidx,:)');shading flat;clim([-3 3]/1e6);colormap(redblue);colorbar
figure();pcolor(plot_time,zz_dbdz,N2_total(pidx,:)');shading flat;clim([-3 3]/1e6);colormap(redblue);colorbar

figure();pcolor(plot_time,zzd_wgrid,www(pidx,:)');shading flat;colormap redblue; colorbar;clim([-1 1]/500)
...
figure();clf;pcolor(plot_time,zz_dbdz,db_dz_w1(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)
figure();clf;pcolor(plot_time,zz_dbdz,db_dz_w2(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)
figure();clf;pcolor(plot_time,zz_dbdz,db_dz_w1(pidx,:)'+db_dz_w2(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)

figure();clf;pcolor(plot_time,zz_dbdz,db_dz_u(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)
figure();clf;pcolor(plot_time,zz_dbdz,db_dz_3(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)
figure();clf;pcolor(plot_time,zz_dbdz,db_dz_5(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)

figure();clf;pcolor(plot_time,zz_dbdz,db_dz_reconst(pidx,:)');shading flat;colormap redblue; colorbar;clim([-3 3]/1e6)
