...
clear;
expdir = 'exps_lambda_0.002/';

m1km =1000;

lambda_parm = [0.05 0.075 0.1 0.25 0.5 1 2.5 5 7.5 10 50 75 100]*m1km;
...
for ne = 1:NEXP
    ...
    expname = ['H1500_topo4_Pt43200_N0.001_S0.001_lambda' num2str(lambda) '_dz' num2str(dz_group(ne)) '_dt' num2str(dt_group(ne)) '_RK4+AB3'];
