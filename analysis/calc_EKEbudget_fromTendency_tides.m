...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fname = [prodir expname '_tavg_5days_h' num2str(h_tides) '.mat'];
o_series = h_tides:12:length(dumpIters);
...
save([prodir expname '_EKEbudget_fromTendency_h' num2str(h_tides) '.mat'], ...
...
print('-djpeg','-r150',[figdir 'EKE_fromTendency_h' num2str(h_tides) '.jpeg']);
